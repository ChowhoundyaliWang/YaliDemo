...
import LessonPage from'./js/Lesson/Lesson';
import WorkPage from './js/Work/WorkNav';
import InformPage from './js/Inform/InformNav';
import MyPage from './js/My/My';

export default class YaliDemo extends Component {
  constructor(){
    super();
    this.state={
      selectedTab:'Lesson',
  ...
  tabBarView(){
    return (
        <TabNavigator
            ...
            >
          {this.renderTabView('课堂','Lesson',LessonPage,true)}
          {this.renderTabView('作业','Work',WorkPage,false)}
          {this.renderTabView('通知','Inform',InformPage,false)}
          {this.renderTabView('我','My',MyPage,false)}
        </TabNavigator>
    );
  }
...
AppRegistry.registerComponent('YaliDemo', () => YaliDemo);
